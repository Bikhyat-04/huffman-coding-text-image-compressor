...
> Built as a Data Structures and Algorithms (DSA) project at Kathmandu University.
...
├── node.py                     # Node class representing a single Huffman tree node
...
Academic project — no license specified. Feel free to open an issue if you'd like to reuse or extend this work.